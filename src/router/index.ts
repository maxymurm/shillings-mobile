...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'scheduled', component: () => import('@/views/transactions/ScheduledTransactionsPage.vue') },
      { path: 'scheduled/create', component: () => import('@/views/transactions/ScheduledTransactionCreatePage.vue') },
      { path: 'budgets', component: () => import('@/views/budgets/BudgetOverviewPage.vue') },
      { path: 'budgets/create', component: () => import('@/views/budgets/BudgetCreatePage.vue') },
      { path: 'contacts', component: () => import('@/views/contacts/ContactListPage.vue') },
      { path: 'contacts/create', component: () => import('@/views/contacts/ContactCreatePage.vue') },
      { path: 'contacts/:id', component: () => import('@/views/contacts/ContactDetailPage.vue') },
      { path: 'documents', component: () => import('@/views/documents/DocumentListPage.vue') },
      { path: 'documents/create', component: () => import('@/views/documents/InvoiceCreatePage.vue') },
      { path: 'documents/:id', component: () => import('@/views/documents/DocumentDetailPage.vue') },
      { path: 'reports', component: () => import('@/views/reports/ReportsPage.vue') },
      { path: 'reports/balance-sheet', component: () => import('@/views/reports/BalanceSheetChartPage.vue') },
      { path: 'reports/income-statement', component: () => import('@/views/reports/IncomeStatementChartPage.vue') },
